...
public class HexUtils {
    ...
    /**
     * Check if a size is between two numbers.
     * @param value The size to check.
     * @param lowest The lowest the size can be.
     * @param highest The highest the size can be.
     */
    public static void assertRange(long value, long lowest, long highest){
        ...
        if(value < lowest || value > highest){
            throw new IllegalArgumentException("size " + value + " must be between " + lowest + " and " + highest);
        }
    }
